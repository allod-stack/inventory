{
  ...
  outputs = { self, nixpkgs, ... }:
    ...
    in
    {
      ...
      checks.x86_64-linux.vm-specs-json = pkgs.runCommand "vm-specs-json-check"
      ...
      checks.x86_64-linux.repository-registry = pkgs.runCommand "repository-registry-check"
